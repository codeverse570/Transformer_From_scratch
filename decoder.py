...
class Decoder(nn.Module):
    def __init__(self, d_model, d_ff, h_count, voc_size, sent_len, layers, batch_size,schedular):
        ...
        self.dropout= {'emb':Dropout(),'self_att_a':Dropout(),'self_att_out':Dropout(),'cross_att_a':Dropout(),'cross_att_out':Dropout(),'ff_layer_1':Dropout(),'ff_out':Dropout()}
...
# entropy: near zero
    ...
    def back_pre(self, targets, prob, smoothing=0.05):
